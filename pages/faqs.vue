<template>
  ...
  <PageBanner :pageName="'Faqs'" />
    ...
    <!-- FAQ's Area start -->
    <section class="faq-area pb-105 rpb-75 rel z-1">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 order-lg-2">
            <div
              class="faq-iamge-part text-lg-end rmb-55 wow fadeInLeft delay-0-2s"
            >
          ...
          <div class="col-lg-7">
            <div class="faq-content-part wow fadeInRight delay-0-2s">
              ...
              <div class="accordion" id="faq-accordion-two">
                <div class="accordion-item">
                  <h5 class="accordion-header">
                    <button
                      class="accordion-button collapsed"
    ...
    <section class="contact-area py-130 rpy-100 rel z-1">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 col-lg-9">
            <div
              class="section-title mb-50 text-center wow fadeInUp delay-0-2s"
            >
              <span class="sub-title mb-15">Work Together</span>
