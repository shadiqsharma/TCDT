...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/devalue/index.js';
import destr from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _XlGLVGX5he = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/sqshadiq/Documents/TCDT/Website Codes/TCDT Website";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _MytBRQgwsp = (nitroApp) => {
...
const _lazy_UnhHMX = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UnhHMX, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UnhHMX, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"assets/images/favicon.png"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&amp;display=swap"},{"rel":"stylesheet","href":"/assets/css/flaticon.min.css"},{"rel":"stylesheet","href":"/assets/css/fontawesome-5.14.0.min.css"},{"rel":"stylesheet","href":"/assets/css/bootstrap.min.css"},{"rel":"stylesheet","href":"/assets/css/magnific-popup.min.css"},{"rel":"stylesheet","href":"/assets/css/nice-select.min.css"},{"rel":"stylesheet","href":"/assets/css/animate.min.css"},{"rel":"stylesheet","href":"/assets/css/slick.min.css"},{"rel":"stylesheet","href":"/assets/css/style.css"},{"rel":"stylesheet","href":"/assets/css/custom.css"}],"style":[],"script":[],"noscript":[],"title":"TC Digital Tech Sdn Bhd","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/sqshadiq/Documents/TCDT/Website%20Codes/TCDT%20Website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
